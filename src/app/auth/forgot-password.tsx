...
export default function ForgotPasswordScreen() {
  ...
  return (
    <View style={styles.root}>
      ...
      />
      <View style={[styles.orb, { top: -80, left: -60, backgroundColor: '#4ECDC4' }]} />
            ...
            {sent ? (
              <View style={styles.sentBox}>
                ...
                <Text style={styles.sentBody}>
                  لینک بازیابی به {email} ارسال شد. صندوق ورودی خود را بررسی کنید.
                </Text>
                <TouchableOpacity onPress={() => router.replace('/auth/login' as any)} style={styles.returnBtn}>
              ...
              <>
                <View style={styles.inputWrapper}>
                  <Ionicons name="mail-outline" size={18} color="#4ECDC4" style={styles.inputIcon} />
                  <TextInput
                    style={styles.input}
                    placeholder="ایمیل"
                  ...
                  <TouchableOpacity style={styles.sendBtn} onPress={handleReset} disabled={loading}>
                    ...
                    >
                      {loading ? (
                        ...
                        <Text style={styles.sendBtnText}>📧  ارسال لینک بازیابی</Text>
                      )}
                    </LinearGradient>
                  </TouchableOpacity>
                </Animated.View>
...
const styles = StyleSheet.create({
  ...
  orb: { position: 'absolute', width: 200, height: 200, borderRadius: 100, opacity: 0.15 },
  ...
  sendBtn: { borderRadius: 14, overflow: 'hidden', shadowColor: '#4ECDC4', shadowRadius: 16, shadowOpacity: 0.6, shadowOffset: { width: 0, height: 4 }, elevation: 8 },
  ...
  sentBody: { fontSize: 14, color: 'rgba(255,255,255,0.6)', textAlign: 'center', lineHeight: 22 },
  returnBtn: {
    marginTop: 8,
